...
This project provides a step-by-step guide to building a professional HR Dashboard in Tableau. It mirrors real-world projects, from gathering requirements to creating polished dashboards.
...
[Tableau-HR-Project-Materials.zip](https://www.datawithbaraa.com/wp-content/uploads/2024/05/Tableau-HR-Project-Materials.zip)

The Zip folder includes:

1. **Project Data**:  
   The HR data used in this project is generated using a combination of ChatGPT prompts and the Python Faker library. It contains employee demographics, job details, salaries, performance evaluations, and attrition data, simulating a real-world HR dataset for analysis and visualization.

2. **Icons & Images**:  
   Icons sourced from Flaticon and customized using Photopea are included to match the dashboard's color scheme. Editable Photopea files are in the `icon` folder.

3. **Mockups**:  
   - Initial dashboard mockup created with Procreate.  
   - Dashboard container designs created using draw.io.
...
- **Detailed Employee Records** for deeper analysis.

### Summary View Sections:

1. **Overview**:  
   - Total employees: hired, active, and terminated.  
   - Hires and terminations trend over the years.  
   - Breakdown of employees by department and job title.  
   - HQ vs. branches comparison (New York is the HQ).  
...
3. **Income Analysis**:  
   ...
   - Correlation between age, salary, and department.

### Employee Records View:

- A detailed list of employees, including name, department, job title, gender, age, education, and salary.  
- Filters available for all columns.

---

## Data Generation

The HR dataset is generated programmatically using Python and the Faker library. Key attributes include:

- Employee ID, Name, Gender, Location, Department, Job Title, Education Level, Performance Rating, Hire Date, Termination Date, Salary, and Birth Date.
- Data generation logic incorporates realistic probabilities for various attributes like job titles, performance ratings, and termination rates.

The Python script for dataset generation is included in this README file under the **Python Script** section.
...
The full Python script used for generating the HR dataset is included below.  
